  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <form onSubmit={submitHandler} className="p-8 bg-white rounded shadow-md w-96">
        ...
        <div className="mb-6 relative"> {/* Added relative for positioning icon */}
          ...
          <button
            ...
            className="absolute inset-y-0 right-0 top-6 pr-3 flex items-center text-sm leading-5" // Adjusted top-6
          >
            {showPassword ? (
              // Eye-slash icon (hide)
